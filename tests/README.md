...
```text
[order-report] working directory: /path/to/aysh
...
[order-report] reproduce with: /path/to/aysh/venv/bin/python /path/to/aysh/tests/run_order_report.py --seed 284734921 -- tests/cli/ -q
```
