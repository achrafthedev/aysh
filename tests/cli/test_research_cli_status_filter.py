"""`aysh-research list --status complete` was returning nothing.
...
Part of #2122 (aysh-* CLI list/search bugs).
"""
...
def _load_cli():
    path = ROOT / "scripts" / "aysh-research"
    loader = importlib.machinery.SourceFileLoader("aysh_research_cli", str(path))
