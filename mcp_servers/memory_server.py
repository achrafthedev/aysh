...
Imports MemoryManager and MemoryVectorStore from the Aysh codebase.
"""
...
_OWNER_ENV_KEYS = ("AYSH_MCP_MEMORY_OWNER", "AYSH_MEMORY_OWNER")
_OWNER_SCOPE_ERROR = (
    "Error: Memory MCP owner is not configured for an owner-scoped memory store. "
    "Set AYSH_MCP_MEMORY_OWNER for this server or use the owner-aware native memory tool."
)
