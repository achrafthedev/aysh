"""scripts/_lib/cli.py — shared scaffolding for the `aysh-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("aysh-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/aysh-foo`
...
VERSION = "0.1.0"  # bumped centrally; every aysh-* CLI reports this
