...
- [ ] I searched [open issues](https://github.com/achrafthedev/aysh/issues) and [open PRs](https://github.com/achrafthedev/aysh/pulls) — this is not a duplicate.
- [ ] This PR targets `dev`
...
- [ ] **Style match**: the change uses Aysh's existing visual language. Specifically:
