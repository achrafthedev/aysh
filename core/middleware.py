...
INTERNAL_TOOL_TOKEN = os.environ.get("AYSH_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Aysh-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Aysh-Internal-Token), or
