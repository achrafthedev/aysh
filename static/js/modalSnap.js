...
const EMAIL_DOC_SPLIT_WIDTH_KEY = 'aysh-email-doc-split-width';
const EDGE_DOCK_WIDTH_KEY_PREFIX = 'aysh-edge-dock-width';
...
(function _initEdgeDockResizeHandles() {
  ...
  window.addEventListener('aysh:modal-opened', _positionEdgeDockResizeHandles);
  _positionEdgeDockResizeHandles();
})();
